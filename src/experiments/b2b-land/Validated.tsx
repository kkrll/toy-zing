  ...
  return (
    <section className="relative flex flex-col gap-2">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-[1fr_2fr] md:gap-12">
          <dl className="flex flex-col gap-6 md:gap-8">
            <div className="flex flex-col gap-1">
              <svg
                className="mb-2 w-24 text-red-500"
                viewBox="0 0 240 113"
                fill="none"
              ...
              <dd className="type-body-md text-theme-text-secondary">
                Partner
              </dd>
            </div>
            <div className="flex flex-col gap-1">
          ...
          <div className="flex aspect-video items-center justify-center bg-theme-bg-400">
            video
          </div>
        </div>
      </div>
      ...
      <ul className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex items-center px-4 py-2 md:pl-14 md:pr-0">
        ...
        {METRICS.map((metric) => (
          <li
            key={metric.value}
            className="flex flex-col gap-1 rounded-3xl bg-theme-bg-200 px-6 py-4"
          >
